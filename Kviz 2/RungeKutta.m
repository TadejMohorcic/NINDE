...
for i = 1:n
    k1 = f(x(i), y(i));
    k2 = f(x(i) + B(2,1)*h, y(i) + B(2,2)*k1*h);
    k3 = f(x(i) + B(3,1)*h, y(i) + (B(3,2)*k1 + B(3,3)*k2)*h);
    k4 = f(x(i) + B(4,1)*h, y(i) + (B(4,2)*k1 + B(4,3)*k2 + B(4,4)*k3)*h);
    k5 = f(x(i) + B(5,1)*h, y(i) + (B(5,2)*k1 + B(5,3)*k2 + B(5,4)*k3 + B(5,5)*k4)*h);
    k6 = f(x(i) + B(6,1)*h, y(i) + (B(6,2)*k1 + B(6,3)*k2 + B(6,4)*k3 + B(6,5)*k4 + B(6,6)*k5)*h);
